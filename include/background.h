...
struct background
{
  ...
  // ADF: VCDM parameters
  double a_dagger_VCDM;
  double Delta_VCDM;
  double zeta_VCDM;
  // ADF: end of new parameters
  ...
  int index_bg_rho_plus_P_VCDM; // ADF: sum_i rho+P over the standard matter fields
  // ADF: adding no free parameters
